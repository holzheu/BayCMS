...
class QBFilter extends QBOrder
{
    protected int $nr;
    public function __construct(
        ...
        $this->fields->addField(new Select($context, name: $this->name . '_bo',
            values: ['('],
            null: 1
        ));
        $this->fields->addField(new Select($context, name: $this->name . '_name',
            values: $this->values,
            null: 1
        ));
        $this->fields->addField(new Select($context, name: $this->name . '_op',
            values: ['=', '!=', '<=', '>=', '<', '>', 'like', 'ilike', 'is null', 'null/empty'],
            null: 1
));
        $this->fields->addField(new TextInput($context, name: $this->name . '_val'));
        $this->fields->addField(new Select($context, name: $this->name . '_bc',
            values: [')'],
            null: 1));
    }
